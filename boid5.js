...
function draw() {
    ...
    fill(0);
    text(`Boid Max Force: ${boidMaxForceSlider.value()}`, 10, height - 180);
    text(`Boid Max Speed: ${boidMaxSpeedSlider.value()}`, 10, height - 160);
    text(`Perception Radius: ${perceptionRadiusSlider.value()}`, 10, height - 140);
    text(`Predator Max Speed: ${predatorMaxSpeedSlider.value()}`, 10, height - 120);
    text(`Predator Max Force: ${predatorMaxForceSlider.value()}`, 10, height - 100);
    text(`Kill Time (ms): ${killTimeSlider.value()}`, 10, height - 80);
